...
import io.excaliburfrc.robot.subsystems.Collection;
...
public class RobotContainer {
  ...
  private final Collection gears = new Collection();
  ...
  private void configureButtonBindings() {
    ...
    // armJoystick
    new JoystickButton(driveJoystick, Button.kSquare.value).whenPressed(gears.raiseCommand());
  }
